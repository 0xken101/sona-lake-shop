---
runme:
  id: 01HQ6KS3208Q0FGYPDYS3HRG3C
  version: v3
---

# Sona Lake Shop

Starter project: [nextjs.org/commerce](https://nextjs.org/commerce)
...
```sh {"id":"01HQ6KS3208Q0FGYPDYFX5FHJH"}
...
```json {"id":"01HQ6KS3208Q0FGYPDYJM9FZTG"}
{
  "features": {
    "wishlist": false,
    "customCheckout": true
...
```sh {"id":"01HQ6KS3208Q0FGYPDYK1P79YY"}
...
```bash {"id":"01HQ6KS3208Q0FGYPDYPDSS8BT"}
commerce/site
❯ yarn dev
yarn run v1.22.17
$ next dev
